...
class UnauthorizedException extends AppException {
  const UnauthorizedException() : super(message: 'Session expired. Please log in again.', statusCode: 401, code: 'UNAUTHORIZED');
}
...
class ServerException extends AppException {
  const ServerException({required super.message}) : super(statusCode: 500, code: 'SERVER_ERROR');
}
